        ...
        public void CaluclateVertex(PlanetChunkObject chunk)
        {
            ...
            if (chunk.Properties != null)
            {
                if (chunk.Properties.LODLevel >= LodColliderStart)
                {
                    ...
                    //chunk.Collider.sharedMesh = chunk.Filter.mesh;//v0.1
                    //chunk.Collider.convex = true; //v0.1
                    ...
                    //MeshCollider collider = chunk.transform.gameObject.AddComponent<MeshCollider>();
